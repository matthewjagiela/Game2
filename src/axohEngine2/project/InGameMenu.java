...
public class InGameMenu {
	...
	private LinkedList<Items> equipment;
	private int[] counts;
	private Items[] shownEquipment;
	private Items[] shownItems;
	...
	public InGameMenu(ImageEntity background, int screenWidth, int screenHeight) {
		...
		equipment = new LinkedList<Items>();
		counts = new int[100];
		shownItems = new Items[100];
		shownEquipment = new Items[100];
	}
...
//		}
	...
	//Reference blue code block above methods
	public void renderItems(JFrame frame, Graphics2D g2d, Items[] array, LinkedList<Items> list) {
	 ...
	 *********************************************************/
	private int getStart(int amount, Items[] array){
		int found = 0;
