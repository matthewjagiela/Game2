...
public class AnimatedSprite extends Sprite {
    ...
    public int getPrevCurrentFrame() { return prevCurrentFrame; }
    	...
    	if(animating) 
    	{
	    	...
	    	if(tempDelay == 0) 
	    	{
	    		...
	    		{	    			
			    	...
			    	tempDelay = delay;
			  //  	animImage.setImage(setSprite(getSheet(), currentFrame())); 
			    	stopAnim(); // stops the moving in place right when player loads
					setAnimTo(nextAnim);
	    			return;
	    		}
