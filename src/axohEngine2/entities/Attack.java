...
public class Attack {
	...
	private Rectangle attackBoundsLocation;
	private LinkedList<Rectangle> attackLeftBounds;
	private LinkedList<Rectangle> attackRightBounds;
	private LinkedList<Rectangle> attackUpBounds;
	private LinkedList<Rectangle> attackDownBounds;
	 ...
	 **************************************************/
	public Attack(String name, int strength, LinkedList<Rectangle> attackLeftBounds, LinkedList<Rectangle> attackRightBounds,
			LinkedList<Rectangle> attackUpBounds, LinkedList<Rectangle> attackDownBounds){
		attackName = name;
		strengthDamage = strength;
	//	this.attackBounds = attackBounds;
		this.attackLeftBounds = attackLeftBounds;
		this.attackRightBounds = attackRightBounds;
		this.attackUpBounds = attackUpBounds;
		this.attackDownBounds = attackDownBounds;
	}
	
	public Rectangle getAttackBounds() { return attackBounds; }
	public Rectangle getAttackBoundsLocation() { return attackBoundsLocation; }
	public LinkedList<Rectangle> getAttackLeftBounds() { return attackLeftBounds; }
	public LinkedList<Rectangle> getAttackRightBounds() { return attackRightBounds; }
	public LinkedList<Rectangle> getAttackUpBounds() { return attackUpBounds; }
	public LinkedList<Rectangle> getAttackDownBounds() { return attackDownBounds; }
	
	public void setAttackBounds(Rectangle attackBounds) { this.attackBounds = attackBounds; }
	public void setAttackBoundsLocation(Rectangle attackBoundsLocation) { this.attackBoundsLocation = attackBoundsLocation; }
	public void setAttackLeftBounds(LinkedList<Rectangle> attackLeftBounds) { this.attackLeftBounds = attackLeftBounds; }
	public void setAttackRightBounds(LinkedList<Rectangle> attackRightBounds) { this.attackLeftBounds = attackRightBounds; }
	public void setAttackUpBounds(LinkedList<Rectangle> attackUpBounds) { this.attackLeftBounds = attackUpBounds; }
	public void setAttackDownBounds(LinkedList<Rectangle> attackDownBounds) { this.attackLeftBounds = attackDownBounds; }
