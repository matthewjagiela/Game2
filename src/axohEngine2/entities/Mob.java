...
public class Mob extends AnimatedSprite{
	...
	private Rectangle boundsLocation;
	
	private Rectangle fullBounds; // entire bounds of player (including head)
	private Rectangle fullBoundsLocation;
	private Rectangle fullLeftBounds;
	...
	private Rectangle hurtBoxLocation;
	private Rectangle hurtBoxRight;
	private Rectangle hurtBoxLeft;
	private Rectangle hurtBoxUp;
	private Rectangle hurtBoxDown;
	private Rectangle healthBarLocation;
	 ...
	 *************************************************************************/
	// Constructor for PLAYER CHARACTER ONLY 
	public Mob(JFrame frame, Graphics2D g2d, SpriteSheet sheet, int spriteNumber, TYPE ai, String name, boolean hostility,
		int startFrame, Rectangle leftBounds, Rectangle rightBounds, Rectangle upBounds, Rectangle downBounds,
		Rectangle fullLeftBounds, Rectangle fullRightBounds, Rectangle fullUpBounds, Rectangle fullDownBounds,
		Rectangle hurtBoxLeft, Rectangle hurtBoxRight, Rectangle hurtBoxUp, Rectangle hurtBoxDown) 
	{
	...
	//	this.boundsLocation = boundsLocation;
		this.hurtBoxLeft = hurtBoxLeft;
		this.hurtBoxRight = hurtBoxRight;
		this.hurtBoxUp = hurtBoxUp;
		this.hurtBoxDown = hurtBoxDown;
		
		this.fullLeftBounds = fullLeftBounds;
		this.fullRightBounds = fullRightBounds;
		this.fullUpBounds = fullUpBounds;
		this.fullDownBounds = fullDownBounds;
		
	//	this.fullBounds = fullBounds;
	//	this.fullBoundsLocation = fullBoundsLocation;
	...
	public Mob(JFrame frame, Graphics2D g2d, SpriteSheet sheet, int spriteNumber, TYPE ai, String name,
			int startFrame, Rectangle bounds, Rectangle leftBounds, Rectangle rightBounds, Rectangle upBounds, Rectangle downBounds,
			Rectangle boundsLocation, Point currentTile, Point startTile, Point currentLocation, Point startLocation,
			Rectangle actionBounds, Rectangle fullBounds, Rectangle fullBoundsLocation, boolean enemy, Rectangle hurtBox) 
	{
			super(frame, g2d, sheet, spriteNumber, name);
			attacks = new LinkedList<Attack>();
			this.frame = frame;
			...
			this.actionBounds = actionBounds;
	...
	public Rectangle getBoundsLocation() { return boundsLocation; }
	public Rectangle getFullBounds() { return fullBounds; }
	public Rectangle getFullBoundsLocation() { return fullBoundsLocation; }
	public Rectangle getFullLeftBounds() { return fullLeftBounds; }
	public Rectangle getFullRightBounds() { return fullRightBounds; }
	public Rectangle getFullUpBounds() { return fullUpBounds; }
	public Rectangle getFullDownBounds() { return fullDownBounds; }
	public Rectangle getHurtBox() { return hurtBox; }
	public Rectangle getHurtBoxLocation() { return hurtBoxLocation; }
	public Rectangle getHurtBoxLeft() { return hurtBoxLeft; }
	public Rectangle getHurtBoxRight() { return hurtBoxRight; }
	public Rectangle getHurtBoxUp() { return hurtBoxUp; }
	public Rectangle getHurtBoxDown() { return hurtBoxDown; }
	public Rectangle getHealthBarLocation() { return healthBarLocation; }
	...
	public void setBoundsLocation_(Rectangle boundsLocation) { this.boundsLocation = boundsLocation; }
	public void setFullBounds_(Rectangle fullBounds) { this.fullBounds = fullBounds; }
	public void setFullBoundsLocation_(Rectangle fullBoundsLocation) { this.fullBoundsLocation = fullBoundsLocation; }
	public void setFullLeftBounds(Rectangle fullLeftBounds) { this.fullLeftBounds = fullLeftBounds; }
	public void setFullRightBounds(Rectangle fullRightBounds) { this.fullRightBounds = fullRightBounds; }
	public void setFullUpBounds(Rectangle fullUpBounds) { this.fullUpBounds = fullUpBounds; }
	public void setFullDownBounds(Rectangle fullDownBounds) { this.fullDownBounds = fullDownBounds; }
	public void setHurtBox(Rectangle hurtBox) { this.hurtBox = hurtBox; }
	public void setHurtBoxLocation(Rectangle hurtBoxLocation) { this.hurtBoxLocation = hurtBoxLocation; }
	public void setHurtBoxLeft(Rectangle hurtBoxLeft) { this.hurtBoxLeft = hurtBoxLeft; }
	public void setHurtBoxRight(Rectangle hurtBoxRight) { this.hurtBoxRight = hurtBoxRight; }
	public void setHurtBoxUp(Rectangle hurtBoxUp) { this.hurtBoxUp = hurtBoxUp; }
	public void setHurtBoxDown(Rectangle hurtBoxDown) { this.hurtBoxDown = hurtBoxDown; }
	public void setHealthBarLocation(Rectangle healthBarLocation) { this.healthBarLocation = healthBarLocation; }
	public void setMaxHealth(int health) { this.maxHealth = health; this.currHealth = health; }
	public void setHealth(int health) { this.currHealth = health; }
		
	public Point getCurrentTile() { return currentTile; }
	public Point getStartTile() { return startTile; }
	public Point getCurrentLocation() { return currentLocation; }
	public Point getStartLocation() { return startLocation; }
	public Rectangle getActionBounds() { return actionBounds; }
	public boolean getEnemy() { return enemy; }
	public void setCurrentTile(Point currentTile) { this.currentTile = currentTile; }
	public void setStartTile(Point startTile) { this.startTile = startTile; }
	...
	public void setActionBounds(Rectangle actionBounds) { this.actionBounds = actionBounds; }
	public void setEnemy(boolean enemy) { this.enemy = enemy; }
	
	public RI getRI() { return ri; }
	public void setRI(RI ri) { this.ri = ri; }
	public boolean getIsAttacked() { return isAttacked; }
	...
	public void inOutItem() {
		...
		if(takenOut) 
		{
			playOnce(currentAttack.getMoveAnim(direction), currentAttack.getMoveTotal(), currentAttack.getMoveDelay(), currentAttack.getInOutAnim(direction) + currentAttack.getInOutTotal());
		}
		else 
		{
	 ...
	 *********************************************************/
	public void addAttack(String name, int strength, LinkedList<Rectangle> attackLeftBounds, LinkedList<Rectangle> attackRightBounds,
			LinkedList<Rectangle> attackUpBounds, LinkedList<Rectangle> attackDownBounds)
	{
		attacks.add(new Attack(name, strength, attackLeftBounds, attackRightBounds, attackUpBounds, attackDownBounds));
	}
	 ...
	 ***********************************************/
	public void renderMob(int x, int y, Graphics2D g2d, JFrame frame) {
