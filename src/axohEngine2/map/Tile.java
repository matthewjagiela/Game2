...
public class Tile extends AnimatedSprite {
	...
	private TileEvent eventType; // type of event it will have
	private Rectangle solidBoundsLocation; // location of solid bounds on map for the specific tile
	private int layer; // layer of tile (can be 0 [player covers tile] or 1 [tile covers player]. 
	...
	public Tile(JFrame frame, Graphics2D g2d, String name, SpriteSheet sheet, int spriteNumber, boolean isSolid,
			boolean isPassable, boolean isPartial, Rectangle location, Rectangle solidBounds, TileEvent eventType,
			Rectangle solidBoundsLocation, int layer)
	{
		...
		this.solidBoundsLocation = solidBoundsLocation;
		this.layer = layer;
//		setSprite(sheet, spriteNumber); //Set the object image to 
	...
	public TileEvent getEventType() { return eventType; }
	public Rectangle getSolidBoundsLocation() { return solidBoundsLocation; }
	...
	public void setEventType(TileEvent eventType) { this.eventType = eventType; }
	public void setSolidBoundsLocation(Rectangle solidBoundsLocation) { this.solidBoundsLocation = solidBoundsLocation; }
	public void setLayer(int layer) { this.layer = layer; }
	public void setMapCoordX(int mapCoordX) { this.mapCoordX = mapCoordX; }
	public void setMapCoordY(int mapCoordY) { this.mapCoordY = mapCoordY; }
